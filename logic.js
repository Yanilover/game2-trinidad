...
// filterZero() function removes the zero from the board, to make the merging possible 
...
// slideLeft() function is responsible in sliding the tiles to the left and merging matching adjacent tiles with the help of the slide() function
...
// slideRight() function is responsible in sliding  the tiles to the left and merging matching adjecent tiles with the help of slide() function
function slideRight(){
    for(let r=0; r<rows; r++){
...
// slideUp() function is responsible in sliding  the tiles to the left and merging matching adjecent tiles with the help of slide() function
function slideUp(){
...
// slideDown() function is responsible in sliding  the tiles to the left and merging matching adjecent tiles with the help of slide() function
function slideDown(){
	for(let c=0; c<columns; c++){
		let col = [board[0][c], board[1][c], board[2][c], board[3][c]];
...
// checkWin() function checks if there is tile that 2048, 4096, or 8192, so that the application will congratulate the user/player. 
function checkWin(){
	for(let r = 0; r<rows; r++){
		for(let c= 0; c<columns; c++){
...
// hasLost() function checks ig there is a vacant tile because if there is the player is not yet lost
//  hasLost() function also checks if there are tiles that could be merged because if it is possible, then the player is not yet lost.
function hasLost(){
	for(let r = 0; r<rows; r++){
		for(let c= 0; c<columns; c++){
